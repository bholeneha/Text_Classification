...
# load models
new_lda = gensim.models.LdaModel.load('/app/Dashboard/model/lda.model')

count_vect, tfidf_transformer, CLF_model = joblib.load('/app/Dashboard/model/clf_model.model')
